%% Important: 4 places need to be changed for different sets
...
for b=1:length(wns)
    ...
    path = strcat(line_folder,sprintf("hBN_ET_50K_%g_S4_fwd_1.csv",wns(b)))
...
% all_indices = readmatrix('/Users/brian_z/Desktop/Research/ET_hBN_fitting/Processing files using matlab/peaks/peaks_326_4-19.csv')
% for c=1:length(wns)
%     x = xs_shift_cell{c}
...
% %     ind = find(cond)
% %     indices = [ind, ind-1, ind-2, ind-3, ind-4, ind-5, ind-6]
